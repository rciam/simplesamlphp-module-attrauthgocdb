...
$this->data['head'] = '<link rel="stylesheet" type="text/css" href="/' . $this->data['baseurlpath'] . 'module.php/attrauthgocdb/resources/css/style.css" />' . "\n";
...
?>
  <p>
    ...
    <div class="warning"><?php print $error_msg ?></div>
  </p>
  ...
  <form style="display: inline; margin-left: .5em;" action="<?php print htmlspecialchars($this->data['logoutLink']); ?>" method="get">
    <?php
